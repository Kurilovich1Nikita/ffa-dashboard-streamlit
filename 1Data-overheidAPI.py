...
for endpoint in endpoints:
    url = f"https://dataderden.cbs.nl/ODataApi/OData/50024NED/{endpoint}" #this path can differ (replace it with the correct one)
...
for endpoint, endpoint_data in data.items():
    ...
    csv_file = os.path.join(directory, f"1{endpoint}.csv")
