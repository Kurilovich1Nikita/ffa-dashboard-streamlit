...
for endpoint in endpoints:
    url = f"https://opendata.cbs.nl/ODataApi/OData/7373llb/{endpoint}" #this path can differ (replace it with the correct one)
...
for endpoint, endpoint_data in data.items():
    ...
    csv_file = os.path.join(directory, f"9{endpoint}.csv")
