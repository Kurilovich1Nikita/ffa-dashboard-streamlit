...
api_url = "https://www.rvo.nl/sites/default/files/2022-05/Prijswaarneming-vleesvarkens-en-biggen.xlsx"
...
if response.status_code == 200:
    ...
    csv_file = os.path.join(directory, "5Prijzen-vleeskalveren.csv")
