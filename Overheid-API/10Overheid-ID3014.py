...
for endpoint in endpoints:
    url = f"https://opendata.cbs.nl/ODataApi/OData/37741nr/{endpoint}" #this path can differ (replace it with the correct one)
...
for endpoint, endpoint_data in data.items():
    ...
    csv_file = os.path.join(directory, f"10{endpoint}.csv")
